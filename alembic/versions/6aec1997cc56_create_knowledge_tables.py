...
down_revision: Union[str, Sequence[str], None] = '2fd9755d5381'
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('organization_id', 'source_type', 'source_entity_id', name='uq_knowledge_sources_org_type_entity')
    )
    ...
    op.create_index('ix_knowledge_sources_organization_project', 'knowledge_sources', ['organization_id', 'project_id'], unique=False)
    ...
    op.create_index('ix_knowledge_chunks_organization_project', 'knowledge_chunks', ['organization_id', 'project_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_knowledge_chunks_organization_project', table_name='knowledge_chunks')
    ...
    op.drop_index('ix_knowledge_sources_organization_project', table_name='knowledge_sources')
